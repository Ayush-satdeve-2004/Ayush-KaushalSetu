    ...
    <header className="sticky top-0 z-40 bg-white border-b border-emerald-100 shadow-sm">
      ...
      <div className="gradient-ayush text-white px-4 py-2 text-xs font-medium flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3 text-emerald-100">
          ...
          <span className="flex items-center space-x-1 bg-emerald-800/60 px-2 py-0.5 rounded">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-3">
        ...
        {/* Active Logged-In Role Portal Display ONLY (Strict role scoping) */}
        <div className="flex items-center space-x-3">
          {/* Active Role Badge */}
          <div className={`flex items-center space-x-2 px-3 py-1.5 rounded-xl border font-bold text-xs shadow-sm ${activeRoleInfo.color}`}>
          ...
          <div className="flex items-center space-x-2 bg-slate-100 p-1.5 rounded-xl border border-slate-200 text-xs">
            ...
            <button
              onClick={onLogout}
              className="bg-white hover:bg-red-50 hover:text-red-700 text-slate-700 font-bold px-3 py-1 rounded-lg border border-slate-200 shadow-sm transition-all flex items-center space-x-1"
